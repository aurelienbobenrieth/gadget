...
description: "An opinionated, community-built ESLint plugin that catches common mistakes in Gadget action files. It ships 16 rules across three categories, auto-fixes where possible, and offers recommended and strict presets."
keywords: ["eslint", "gadget", "actions", "linting", "plugin", "static analysis", "developer tools"]
"og:title": "Gadget ESLint Plugin - Catch action file mistakes at lint time"
"og:description": "16 rules across three categories with auto-fix support. Community-built ESLint plugin for Gadget action files."
---
